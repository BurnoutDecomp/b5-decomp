"""Shared plumbing for the FX-VMNET regression runners (crash parity 2026-09-23).
...
Run the runners from the workflow checkout with
    env -u NoDefaultCurrentDirectoryInExePath python b5-decomp/tests/run_fxvmnet_<name>.py
...
def build_and_run(harness, pieces, label):
