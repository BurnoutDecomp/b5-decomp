...
// =============================================================================
// CgsModule::EventQueue<CgsSceneManager::OverlapGenerationIO::InRemoveBodyEvent, 16384>::Construct
...
// {T*,s32,s32} header + 4 pad; the pad comes from InRemoveBodyEvent's u64 8-byte
...
// sizeof(InRemoveBodyEvent)==0x10. This is the InputBuffer's mRemoveBodyQueue member
