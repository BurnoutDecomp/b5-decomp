...
// =============================================================================
// CgsModule::EventQueue<CgsSceneManager::OverlapGenerationIO::InUpdateBodyEvent, 16384>::Construct
...
// {T*,s32,s32} header + 4 tail pad for the alignas(16) InUpdateBodyEvent[]). The element
// stride is 64 bytes (AddEvent's slwi r10,r10,6), so sizeof(InUpdateBodyEvent)==0x40.
