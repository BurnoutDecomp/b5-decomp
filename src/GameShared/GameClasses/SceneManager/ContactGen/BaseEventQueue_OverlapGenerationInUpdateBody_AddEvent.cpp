...
#include "GameShared/GameClasses/SceneManager/ContactGen/CgsOverlapGenerationModule.h"    // OverlapGenerationIO::InUpdateBodyEvent (64-byte element)

// =============================================================================
// CgsModule::BaseEventQueue<CgsSceneManager::OverlapGenerationIO::InUpdateBodyEvent>::AddEvent
...
// sizeof(InUpdateBodyEvent) == 0x40. The InputBuffer's mUpdateBodyQueue is the derived
// EventQueue<InUpdateBodyEvent,16384>, which appends through this inherited base AddEvent.
// =============================================================================
template bool
CgsModule::BaseEventQueue<CgsSceneManager::OverlapGenerationIO::InUpdateBodyEvent>::AddEvent(
    const CgsSceneManager::OverlapGenerationIO::InUpdateBodyEvent& lEvent);
