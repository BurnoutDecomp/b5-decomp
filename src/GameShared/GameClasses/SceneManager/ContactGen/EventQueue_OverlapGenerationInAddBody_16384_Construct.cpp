...
// =============================================================================
// CgsModule::EventQueue<CgsSceneManager::OverlapGenerationIO::InAddBodyEvent, 16384>::Construct
...
// {T*,s32,s32} header + 4 tail pad for the alignas(16) InAddBodyEvent[]). The element
// stride is 64 bytes (sibling AddEvent's slwi r10,r10,6 @0x828B85D8), so
// sizeof(InAddBodyEvent)==0x40. This is the InputBuffer's add-body queue member type;
