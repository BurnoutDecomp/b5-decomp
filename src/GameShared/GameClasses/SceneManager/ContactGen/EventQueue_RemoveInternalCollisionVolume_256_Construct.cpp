...
#include "GameShared/GameClasses/SceneManager/ContactGen/CgsOverlapCullingModuleIO.h" // OverlapCullingIO::RemoveInternalCollisionVolume

// =============================================================================
// CgsModule::EventQueue<CgsSceneManager::OverlapCullingIO::RemoveInternalCollisionVolume, 256>::Construct
//   @ 0x828C4E90   (ledger id: class:CgsSceneManager::OverlapCullingIO)
//
// Reconstructed from BURNOUT_X360_ARTIST.XEX (semantic parity, asm widths matched).
// The fixed-capacity (N = 256) internal-volume-remove request queue: the 256 events live inline
...
//
// X360 store-for-store (asm at 0x828C4E90, offsets are the BaseEventQueue header):
...
// pointer lands at this+0xC (NOT 0x10): RemoveInternalCollisionVolume is only 4-aligned (1 u32),
...
// InputBuffer's three EventQueues). NOTE: this ledger TU (class:CgsSceneManager::OverlapCullingIO)
// names the RemoveInternalCollisionVolume,256> Construct @0x828C4E90 -- the AddInternalCollision
// Volume,256> Construct @0x828C4E20 is the sibling ledger TU bodied in
// EventQueue_AddInternalCollisionVolume_256_Construct.cpp.
// =============================================================================
template void
CgsModule::EventQueue<CgsSceneManager::OverlapCullingIO::RemoveInternalCollisionVolume, 256>::Construct();
