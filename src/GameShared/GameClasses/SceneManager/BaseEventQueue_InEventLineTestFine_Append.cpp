...
// CgsModule::BaseEventQueue<CgsSceneManager::SceneManagerIO::InEventLineTestFine>::Append
//   @ X360 0x823C1FA0 (dossier id "class:CgsSceneManager::SceneManagerIO::InEventLineTestFine>").
//
...
// The 64-byte stride matches sizeof(InEventLineTestFine) == 0x40 (alignas(16), per the committed
// CgsSceneManagerIO_EventLineTest.h element definition shared with InEventLineTestFastDoubleSided),
// the X360-attested stride read directly off this very Append. This is the Append member of the
// EventQueue<InEventLineTestFine,N> family whose Construct instantiations live in
// EventQueue_InEventLineTestFine_{10,256}.cpp; called from
// CgsSceneManager::SceneManagerIO::SceneQueryInterface::Append and
// WorldModule::BridgeRaceCarModuleToSceneModule_PostScene.
template bool
CgsModule::BaseEventQueue<CgsSceneManager::SceneManagerIO::InEventLineTestFine>::Append(
    const CgsModule::BaseEventQueue<CgsSceneManager::SceneManagerIO::InEventLineTestFine>&);
