...
// =============================================================================
// CgsModule::EventQueue<CgsSceneManager::SceneManagerIO::InEventLineTestFine, 10>::Construct
//   @ 0x8222DA08   (ledger id: class:CgsSceneManager::SceneManagerIO::InEventLineTestFine,10>)
//
// Reconstructed from BURNOUT_X360_ARTIST.XEX (semantic parity, not byte match).
// The fixed-capacity (N = 10) fine-line-test input queue: the 10 InEventLineTestFine records
// live inline in the derived EventQueue's maEvents[10] buffer, and Construct() points the base
...
// explicit instantiation the X360 emitted out-of-line for the InEventLineTestFine/10
// specialisation. Reached from BrnDirector::DirectorIO::SceneQueryOutputBuffer::Construct.
//
// X360 store-for-store (asm at 0x8222DA08), offsets are the BaseEventQueue header:
