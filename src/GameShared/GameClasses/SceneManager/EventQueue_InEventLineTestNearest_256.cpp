...
// =============================================================================
// CgsModule::EventQueue<CgsSceneManager::SceneManagerIO::InEventLineTestNearest, 256>::Construct
//   @ 0x828C4688   (ledger id: class:CgsSceneManager::SceneManagerIO::InEventLineTestNearest,256>)
//
// Reconstructed from BURNOUT_X360_ARTIST.XEX (semantic parity, not byte match).
// The fixed-capacity (N = 256) nearest-line-test input queue: the 256 InEventLineTestNearest
// records live inline in the derived EventQueue's maEvents[256] buffer, and Construct()
// points the base queue at that inline storage, sets the capacity and clears the live count.
// The generic EventQueue<T, N>::Construct body is already inline in CgsEventQueue.h; this TU
// is the thin explicit instantiation the X360 emitted out-of-line for the
// InEventLineTestNearest/256 specialisation -- the sibling of the /40 instantiation
// (EventQueue_InEventLineTestNearest_40.cpp; distinct N, no ODR clash). Reached from
// CgsSceneManager::SceneManagerIO::InputBuffer_Query::Construct.
//
// X360 store-for-store (asm at 0x828C4688), offsets are the BaseEventQueue header:
