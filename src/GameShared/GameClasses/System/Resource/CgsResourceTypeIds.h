...
namespace CgsResource
{
    enum EResourceType
    {
        ...
        E_RESOURCETYPE_LUACODE                  = 0x22,  // CgsResource::LuaCodeResourceType (FSM Lua scripts); X360 = 34
        E_RESOURCETYPE_ICE_TAKE_DICTIONARY      = 0x41,  // wiki "ICETakeDictionary"; X360 DictionaryResourceType<ICE::ICETakeData>::GetTypeID 0x826659E0 = 65
