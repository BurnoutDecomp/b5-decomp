...
// CgsModule::EventQueue<CgsResource::Events::LoadBundleResponse, 256>::Construct
...
template void CgsModule::EventQueue<CgsResource::Events::LoadBundleResponse, 256>::Construct();
