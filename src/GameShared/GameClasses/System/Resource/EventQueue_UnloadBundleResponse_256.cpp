...
// CgsModule::EventQueue<CgsResource::Events::UnloadBundleResponse, 256>::Construct
...
template void CgsModule::EventQueue<CgsResource::Events::UnloadBundleResponse, 256>::Construct();
