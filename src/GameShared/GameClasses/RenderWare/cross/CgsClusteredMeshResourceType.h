...
// import pointers). FixDown/FixUp/GetImportPointer/GetTypeID are defined in
// CgsClusteredMeshResourceType.cpp; ReBase in CgsResourceType.cpp. Base/signatures
// recovered from the DecFIGS DWARF (CgsClusteredMeshResourceType.h).
