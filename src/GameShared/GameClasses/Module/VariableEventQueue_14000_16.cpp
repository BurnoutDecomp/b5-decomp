...
// AppendSafe<SRCBUF,16> members the X360 emits out-of-line for THIS <14000,16>
...
template bool CgsModule::VariableEventQueue<14000, 16>::Append<14000, 16>(const CgsModule::VariableEventQueue<14000, 16>&);
