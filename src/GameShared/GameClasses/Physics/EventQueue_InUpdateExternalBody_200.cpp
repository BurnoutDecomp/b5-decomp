...
// CgsModule::EventQueue<CgsPhysics::PhysicsSimulationIO::InUpdateExternalBody, 200>::Construct
//   @ X360 0x828A6688 (dossier id "class:CgsPhysics::PhysicsSimulationIO::InUpdateExternalBody,200>").
//
...
template void CgsModule::EventQueue<CgsPhysics::PhysicsSimulationIO::InUpdateExternalBody, 200>::Construct();
