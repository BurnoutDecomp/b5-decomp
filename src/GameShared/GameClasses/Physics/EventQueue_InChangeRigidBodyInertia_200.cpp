...
// CgsModule::EventQueue<CgsPhysics::PhysicsSimulationIO::InChangeRigidBodyInertia, 200>::Construct
//   @ X360 0x825A7B28
//   (dossier id "class:CgsPhysics::PhysicsSimulationIO::InChangeRigidBodyInertia,200>").
//
...
//
// This capacity-200 change-inertia queue lives across the input/output buffers (X360 callers
// BrnPhysics::PhysicsModuleIO::OutputBuffer::Construct,
// BrnPhysics::Vehicle::VehicleManagerOutputBuffer::Construct and
...
template void CgsModule::EventQueue<CgsPhysics::PhysicsSimulationIO::InChangeRigidBodyInertia, 200>::Construct();
