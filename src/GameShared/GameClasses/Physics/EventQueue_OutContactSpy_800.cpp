...
// CgsModule::EventQueue<CgsPhysics::PhysicsSimulationIO::OutContactSpy, 800>::Construct
//   @ X360 0x828A68B8 (dossier id "class:CgsPhysics::PhysicsSimulationIO::OutContactSpy,800>").
//
// Fixed-capacity (800) event-queue instantiation: the derived EventQueue<T,800>::Construct points
...
// the max length (800 == 0x320, the asm's `li r11,0x320; stw r11,4(r31)`) and clears the live count
...
template void CgsModule::EventQueue<CgsPhysics::PhysicsSimulationIO::OutContactSpy, 800>::Construct();
