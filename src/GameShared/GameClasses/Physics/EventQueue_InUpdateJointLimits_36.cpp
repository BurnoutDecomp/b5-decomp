...
// CgsModule::EventQueue<CgsPhysics::PhysicsSimulationIO::InUpdateJointLimits, 36>::Construct
//   @ X360 0x828A6378 (dossier id "class:CgsPhysics::PhysicsSimulationIO::InUpdateJointLimits,36>").
//
...
template void CgsModule::EventQueue<CgsPhysics::PhysicsSimulationIO::InUpdateJointLimits, 36>::Construct();
