...
// CgsModule::EventQueue<CgsPhysics::PhysicsSimulationIO::InAddRigidBody, 1>::Construct
//   @ X360 0x825A8228 (dossier id "class:CgsPhysics::PhysicsSimulationIO::InAddRigidBody,1>").
//
...
//
// This capacity-1 rigid-body queue is reached by BrnPhysics::PhysicsModule::PrepareWorldRigidBody.
...
template void CgsModule::EventQueue<CgsPhysics::PhysicsSimulationIO::InAddRigidBody, 1>::Construct();
