...
// CgsModule::EventQueue<CgsPhysics::PhysicsSimulationIO::InUpdateDriveFrames, 1>::Construct
//   @ X360 0x828A6538 (dossier id "class:CgsPhysics::PhysicsSimulationIO::InUpdateDriveFrames,1>").
//
...
template void CgsModule::EventQueue<CgsPhysics::PhysicsSimulationIO::InUpdateDriveFrames, 1>::Construct();
