...
//   CgsNetwork::ServerInterfaceBroadcastMessages::~ServerInterfaceBroadcastMessages
//       ['scalar deleting destructor' thunk] @ 0x827DE1A8
//
// MSVC's scalar-deleting-destructor for the polymorphic ServerInterfaceBroadcastMessages
