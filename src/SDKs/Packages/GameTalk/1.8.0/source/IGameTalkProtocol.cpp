...
// r3. IGameTalkProtocol is an abstract base with no members and no base subobject,
// so the destructor body is empty: defining ~IGameTalkProtocol() out-of-line emits
