#include "SDKs/XAudio/XAudioPacketList.h"

// ===========================================================================
// XAUDIO::CPacketList::~CPacketList @ 0x8296C328 -- reconstructed from
// BURNOUT_X360_ARTIST.XEX. The PowerPC asm is authoritative for every store;
// see XAudioPacketList.h for the layout. No reference source and no DWARF
// exist for this TU.
// ===========================================================================
...
//         (loop)
XAUDIO::CPacketList::~CPacketList()
{
