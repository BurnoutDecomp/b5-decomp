...
namespace BrnGame
{
    ...
    // @ 0x823CDE50 BridgeGameStateToSound: MOVED OUT (faithful-audio-engine phase C4b)
    // to GameBridgeGameStateToX_Sound.cpp so it can be MOUNTED on its own, the same
    // sibling split as _TrainingStringIds and the GUI-bridge family. Moved, not copied.
