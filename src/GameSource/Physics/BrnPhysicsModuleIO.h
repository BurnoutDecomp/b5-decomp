...
// its member is the REAL Props::PropOutputInterface now
...
// its member is the REAL SceneManagerIO::InSceneUpdateInterface
...
namespace PhysicsModuleIO
{
    ...
    private:
        ...
        // two of the three folded queues are REAL members now,
