...
// CgsModule::EventQueue<BrnPhysics::Vehicle::ResetVehicleEvent, 16>::Construct
...
template void CgsModule::EventQueue<BrnPhysics::Vehicle::ResetVehicleEvent, 16>::Construct();
