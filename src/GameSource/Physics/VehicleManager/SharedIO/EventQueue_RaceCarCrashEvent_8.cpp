...
// CgsModule::EventQueue<BrnPhysics::Vehicle::RaceCarCrashEvent, 8>::Construct
...
template void CgsModule::EventQueue<BrnPhysics::Vehicle::RaceCarCrashEvent, 8>::Construct();
