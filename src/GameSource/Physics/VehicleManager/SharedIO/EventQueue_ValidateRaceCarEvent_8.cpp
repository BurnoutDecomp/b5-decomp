...
// CgsModule::EventQueue<BrnPhysics::Vehicle::ValidateRaceCarEvent, 8>::Construct
...
template void CgsModule::EventQueue<BrnPhysics::Vehicle::ValidateRaceCarEvent, 8>::Construct();
