...
// CgsModule::EventQueue<BrnPhysics::Vehicle::SetRaceCarCollisionEvent, 10>::Construct
...
template void CgsModule::EventQueue<BrnPhysics::Vehicle::SetRaceCarCollisionEvent, 10>::Construct();
