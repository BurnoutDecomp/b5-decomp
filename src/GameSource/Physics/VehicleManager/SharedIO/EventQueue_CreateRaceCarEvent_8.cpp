...
// CgsModule::EventQueue<BrnPhysics::Vehicle::CreateRaceCarEvent, 8>::Construct
...
template void CgsModule::EventQueue<BrnPhysics::Vehicle::CreateRaceCarEvent, 8>::Construct();
