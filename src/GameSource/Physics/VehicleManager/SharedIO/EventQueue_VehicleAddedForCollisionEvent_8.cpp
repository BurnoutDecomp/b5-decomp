...
// CgsModule::EventQueue<BrnPhysics::Vehicle::VehicleAddedForCollisionEvent, 8>::Construct
...
template void CgsModule::EventQueue<BrnPhysics::Vehicle::VehicleAddedForCollisionEvent, 8>::Construct();
