...
#include "GameSource/Physics/PropManager/SharedIO/BrnPropEvents.h"             // BrnPhysics::Props::RemovePhysicalPartEvent (8-byte element)

// =============================================================================
// CgsModule::BaseEventQueue<BrnPhysics::Props::RemovePhysicalPartEvent>::AddEvent @ 0x822C8768
// CgsModule::BaseEventQueue<BrnPhysics::Props::RemovePhysicalPartEvent>::Append  @ 0x827A8110
//
...
//
// AddEvent (0x822C8768) asserts mpEvents != NULL (CgsBaseEventQueue.h:312) and
// miLength < miMaxLength (:313, whose de-inlined StrStream
// "CgsModule::BaseEventQueue<class BrnPhysics::Props::RemovePhysicalPartEvent>::AddEvent\n
...
//
// Append (0x827A8110) asserts mpEvents != NULL (:413), no overflow (:414 "Base event queue
...
//
// sizeof(BrnPhysics::Props::RemovePhysicalPartEvent) == 8, matching the 8-byte stride in both
...
// AddEvent is called from PropInputInterface::RemovePartInstance; Append from
// PropInputInterface::Append and WorldModule::BridgeEntityModulesToPhysicsModule_PrePhysics.
// DWARF (CgsBaseEventQueue.h:3664/3676) confirms both member signatures on
// BaseEventQueue<BrnPhysics::Props::RemovePhysicalPartEvent>.
// =============================================================================
template bool
CgsModule::BaseEventQueue<BrnPhysics::Props::RemovePhysicalPartEvent>::AddEvent(
    const BrnPhysics::Props::RemovePhysicalPartEvent&);

template bool
CgsModule::BaseEventQueue<BrnPhysics::Props::RemovePhysicalPartEvent>::Append(
    const CgsModule::BaseEventQueue<BrnPhysics::Props::RemovePhysicalPartEvent>&);
