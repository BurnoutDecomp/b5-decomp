...
// includes folded in from the BrnPhysicsModule_w*.cpp partfiles (2026-09-15)
...
// ============================================================================
// FOLDED FROM BrnPhysicsModule_wG_GameActionsPostScene.cpp (wave G) on 2026-09-15 by tools/work/fold_partfiles.py.
