...
// includes folded in from the BrnTriggerEntityModule_w*.cpp partfiles (2026-09-15)
...
// ============================================================================
// FOLDED FROM BrnTriggerEntityModule_wG_Stages.cpp (wave G) on 2026-09-15 by tools/work/fold_partfiles.py.
...
namespace
{
// (fold: an identical definition of KAC_FILE was dropped here -- this TU defines it once, above)

// (fold: an identical definition of KU_ENTITYTYPE_TRIGGER was dropped here -- this TU defines it once, above)
}
