...
#include "GameSource/World/CrashModule/SharedIO/BrnCrashModuleTrafficIOInterfaces.h" // BrnWorld::CrashIO::RemoveSlammedTrafficEvent (2-byte element)

// CgsModule::BaseEventQueue<BrnWorld::CrashIO::RemoveSlammedTrafficEvent>::AddEvent @ 0x8271A430
// CgsModule::BaseEventQueue<BrnWorld::CrashIO::RemoveSlammedTrafficEvent>::Append  @ 0x827A82D0
...
//
// AddEvent (0x8271A430) asserts mpEvents != NULL (CgsBaseEventQueue.h:312) and
...
//
// Append (0x827A82D0) asserts mpEvents != NULL (CgsBaseEventQueue.h:413), no overflow
...
//
// sizeof(RemoveSlammedTrafficEvent) == 2 (single u16 muVehicleId), matching the 2-byte stride
// in both bodies. AddEvent is called by BrnTraffic::TrafficEntityModule::GenerateSlamRecoveryEvents;
// Append by BrnWorld::CrashIO::TrafficInputInterface::operator=.
template bool
CgsModule::BaseEventQueue<BrnWorld::CrashIO::RemoveSlammedTrafficEvent>::AddEvent(
    const BrnWorld::CrashIO::RemoveSlammedTrafficEvent&);

template bool
CgsModule::BaseEventQueue<BrnWorld::CrashIO::RemoveSlammedTrafficEvent>::Append(
    const CgsModule::BaseEventQueue<BrnWorld::CrashIO::RemoveSlammedTrafficEvent>&);
