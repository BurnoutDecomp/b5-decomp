...
#include "GameSource/World/CrashModule/SharedIO/BrnCrashModuleTrafficIOInterfaces.h" // BrnWorld::CrashIO::RemoveSlammedTrafficEvent

// CgsModule::EventQueue<BrnWorld::CrashIO::RemoveSlammedTrafficEvent, 160>::Construct @ 0x82760830
...
template void CgsModule::EventQueue<BrnWorld::CrashIO::RemoveSlammedTrafficEvent, 160>::Construct();
