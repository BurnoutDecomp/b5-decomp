...
// includes folded in from the BrnCarSelectLivery_w*.cpp partfiles (2026-09-15)
...
// ============================================================================
// FOLDED FROM BrnCarSelectLivery_wJ_01.cpp (wave J) on 2026-09-15 by tools/work/fold_partfiles.py.
