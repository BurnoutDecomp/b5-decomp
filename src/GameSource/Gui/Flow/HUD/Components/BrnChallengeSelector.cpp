...
// includes folded in from the BrnChallengeSelector_w*.cpp partfiles (2026-09-15)
...
// ============================================================================
// FOLDED FROM BrnChallengeSelector_wL_01.cpp (wave L) on 2026-09-15 by tools/work/fold_partfiles.py.
