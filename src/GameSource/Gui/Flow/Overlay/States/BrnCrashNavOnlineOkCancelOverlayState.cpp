...
// Reconstructed from BURNOUT_X360_ARTIST.XEX @ 0x824B1DE0
// (BrnGui::CrashNavOnlineOkCancelOverlayState::FillInPopupType): a single store of the
...
namespace BrnGui
{
    const char CrashNavOnlineOkCancelOverlayState::KPC_CRASH_NAV_FRAME_LABEL[15] = "CrashNavOnline";

    // @ 0x824B1DE0
    void CrashNavOnlineOkCancelOverlayState::FillInPopupType()
    {
