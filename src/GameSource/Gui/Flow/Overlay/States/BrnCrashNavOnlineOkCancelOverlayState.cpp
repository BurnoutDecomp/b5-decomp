...
//   (BrnGui::CrashNavOnlineOkCancelOverlayState::FillInPopupType)
//
...
namespace BrnGui
{
    ...
    {
        CrashNavOnlineOkCancelOverlayState* FillInPopupType();
    };

    CrashNavOnlineOkCancelOverlayState* CrashNavOnlineOkCancelOverlayState::FillInPopupType()
    {
