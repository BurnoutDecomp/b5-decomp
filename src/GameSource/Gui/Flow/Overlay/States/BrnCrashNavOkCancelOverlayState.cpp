...
// (BrnGui::CrashNavOkCancelOverlayState::FillInPopupType): a single store of the
...
namespace BrnGui
{
    const char CrashNavOkCancelOverlayState::KPC_CRASH_NAV_FRAME_LABEL[9] = "CrashNav";

    // @ 0x824B1DB0
    void CrashNavOkCancelOverlayState::FillInPopupType()
    {
