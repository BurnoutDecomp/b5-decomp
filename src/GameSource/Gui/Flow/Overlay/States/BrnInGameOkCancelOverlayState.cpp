...
// (BrnGui::InGameOkCancelOverlayState::FillInPopupType): a single store of the
...
namespace BrnGui
{
    const char InGameOkCancelOverlayState::KPC_IN_GAME_FRAME_LABEL[7] = "InGame";

    // @ 0x824B1E10
    void InGameOkCancelOverlayState::FillInPopupType()
    {
