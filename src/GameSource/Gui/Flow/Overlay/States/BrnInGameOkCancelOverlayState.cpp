...
// Reconstructed from BURNOUT_X360_ARTIST.XEX @ 0x824B1E10
//   (BrnGui::InGameOkCancelOverlayState::FillInPopupType)
//
...
namespace BrnGui
{
    ...
    {
        InGameOkCancelOverlayState* FillInPopupType();
    };

    InGameOkCancelOverlayState* InGameOkCancelOverlayState::FillInPopupType()
    {
        *reinterpret_cast<const char**>(reinterpret_cast<u8*>(this) + 268) = "InGame";
        return this;
    }
}
