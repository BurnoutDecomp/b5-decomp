...
// id 0, 0x1B000-byte buffers, "RaceCarEntity", flag 1), then clears a single
// byte field (stb, not stw) at offset 0x5C of the object before returning the
// base result. BaseSerialiser is reconstructed by its own TU; declared here
...
namespace BrnReplays
{
    struct BaseSerialiser
    {
        ...
        u8   muField5C;     // [0x5C] cleared after Construct by this serialiser (stb, byte-wide)
