...
// Explicit instantiations of the EventQueue<BrnGameState::GameStateToGuiTookLastEvent, 1> methods reconstructed
...
template void CgsModule::EventQueue<BrnGameState::GameStateToGuiTookLastEvent, 1>::Construct();
