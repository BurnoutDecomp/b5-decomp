...
//
// Construct / Parameters::Construct are simple resets. Update is a KEYSTONE: see the documented
// floor at its definition below. Parameters::Serialise<S> lives in the sibling
// BrnPositionLagSerialise.cpp, so this TU mounts without the camera-tunings serialiser types.
// ============================================================================
