...
//
// Compilation home for the BrnDirector::Camera::Utils::CameraShake::Parameters serialiser
// slice this TU owns (class:BrnDirector::Camera::Utils::CameraShake::Parameters):
...
//
// CameraShake::Parameters itself (the four f32 shake tunables) is already homed, fully
// laid out, in BehaviourRig.h (DWARF home BrnCameraShake.h); this TU only bodies the ONE
// field-walk visitor declared there and instantiates it over the three camera-tunings
// serialisers. The block is the shake post-process tunings shared by the gameplay/bystander/
// gyro/aftertouch/heli camera behaviours (each embeds a CameraShake and saves/loads/menus
// this block through its own Serialise<T>).
// ============================================================================

#include "GameSource/Director/Camera/Behaviours/BehaviourRig.h"          // Utils::CameraShake::Parameters (the block being walked)
