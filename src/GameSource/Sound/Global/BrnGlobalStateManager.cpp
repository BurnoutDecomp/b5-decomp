...
//
// ObjectID RESOLVED (PS3 DecFIGS static-init 0x85FA1C): GlobalStateManager::sTypeInfo
// .ObjectID = 0. The descriptor comes from GetStaticTypeInfo() (seeded with that id and
